            ...
            <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4">
              <div className="flex flex-shrink-0 items-center px-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xl font-bold text-gray-900">SafePing</span>
                </div>
              </div>
          ...
          <div className="flex flex-1 flex-col pt-8 pb-4 overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-6">
              <div className="flex items-center space-x-3">
                <img src="/safeping-logo.png" alt="SafePing" className="w-10 h-10 rounded-lg" />
                <div>
                  <span className="text-2xl font-bold bg-gradient-to-r from-[#15a2a6] to-teal-500 bg-clip-text text-transparent">SafePing</span>
